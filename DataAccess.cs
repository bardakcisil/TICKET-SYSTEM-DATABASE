...
namespace FormUI
{
    public class DataAccess
    {
        ...
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("SampleDB")))//connection string
            {
        ...
        public void InsertPerson(string firstName, string lastName, string emailAddress, string phoneNumber)
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("SampleDB")))//connection string
            {
                ...
                //newPerson.FirstName =firstName seklindede alt alta yazabilrdik kısa olsun diye asagidaki gibi yazdik
                ...
                connection.Execute("dbo.People_Insert @FirstName, @LastName, @EmailAddress, @PhoneNumber", people); //people list person
            }
        }
    }
}
